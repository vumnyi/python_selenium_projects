...
def test_upload_file(browser, admin_autorization):
    ...
    WebDriverWait(browser, 5).until(
        EC.element_to_be_clickable((By.XPATH, AdminPage.AdminNavigation.sections_item('Downloads'))))
    browser.find_element_by_xpath(AdminPage.AdminNavigation.sections_item('Downloads')).click()
